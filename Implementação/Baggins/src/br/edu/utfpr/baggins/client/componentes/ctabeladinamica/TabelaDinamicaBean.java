...
@ViewScoped
public class TabelaDinamicaBean implements Serializable
{
	...
	private static HashMap<Object, Object> mapaPrincipal = new HashMap<Object, Object>();
	...
	public void ini()
	{
		...
		dataModel = null;
		array = CControleDinamicoPU.buscaGenericaNova(classeGeral, "");
		contador++;
	}
